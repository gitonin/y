...
> Les règles sont les mêmes que pour le document des textes du site :

> 1. Ne touchez pas au code entre crochets. C’est lui qui me dit où va chaque texte.

> 2. Écrivez sous le code, à la place du texte existant. Vous pouvez tout réécrire, rallonger, raccourcir.

> 3. Dans une liste, gardez une ligne par point. Le nombre de points peut changer.
...
> Le titre et la description comptent double : ce sont eux qui s’affichent dans Google et dans la liste des articles.

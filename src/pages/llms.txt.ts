...
export const GET: APIRoute = async ({ site }) => {
  ...
  push(
    ...
    '',
    "Yunma est un torréfacteur français spécialisé dans les cafés de spécialité du Yunnan (Chine). La marque achète en direct auprès de cinq familles productrices à Baoshan, Pu'er et Menglian, entre 1 200 et 1 900 mètres d'altitude, et torréfie en petites séries. Le site est disponible en français, anglais et chinois simplifié. Le paiement et l'expédition sont opérés par Shopify.",
    '',
    '## Informations clés',
    '',
    `- Nom : ${SITE.name}`,
    `- Activité : sélection, importation et torréfaction de cafés de spécialité du Yunnan`,
    `- Origine des cafés : Yunnan, Chine (Baoshan, Pu'er, Menglian), altitude 1 200–1 900 m`,
